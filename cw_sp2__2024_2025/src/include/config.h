...
#define KEYWORDS_RE       ";|<-|,|EQ|NE|:|\\(|\\)|!>|!<|PROGRAM|VAR|BEGIN|END|EXIT|CONTINUE|END|SCAN|PRINT|IF|ELSE|FOR|TO|DOWNTO|DO|WHILE|REPEAT|UNTIL|GOTO|ADD|MUL|SUB|DIV|MOD|AND|OR|NOT|LONG_INT"
...
{"tokenSEMICOLON__tokenDATA", 2, {"tokenSEMICOLON","tokenDATA__declaration"}},\
{"tokenNAME__program_name__tokenSEMICOLON__tokenDATA", 2, {"tokenNAME__program_name","tokenSEMICOLON__tokenDATA"}},\
{"program____part1", 2, {"tokenNAME__program_name__tokenSEMICOLON__tokenDATA","tokenSEMICOLON"}},\
...
{"program____part2", 2, {"tokenBODY","statement____iteration_after_two__tokenEND"}},\
...
{"tokenSEMICOLON__tokenDATA", 2, {"tokenSEMICOLON","tokenDATA__declaration"}},\
{"tokenSEMICOLON__tokenDATA", 2, {"tokenSEMICOLON","tokenDATA"}},\
{"program____part1", 2, {"tokenNAME__program_name","tokenSEMICOLON__tokenDATA"}},\
{"statement__tokenEND", 2, {"statement","tokenEND"}},\
{"statement____iteration_after_two__tokenEND", 2, {"statement____iteration_after_two","tokenEND"}},\
{"tokenSEMICOLON__tokenBODY", 2, {"tokenSEMICOLON","tokenBODY"}},\
{"program____part2", 2, {"tokenSEMICOLON__tokenBODY","statement____iteration_after_two__tokenEND"}},\
{"program____part2", 2, {"tokenSEMICOLON__tokenBODY","statement__tokenEND"}},\
...
#define T_BODY_0 "BEGIN"
#define T_DATA_0 "VAR"
#define T_DATA_TYPE_0 "LONG_INT"
